...
class PlayList:
    ...
    def get_pl_title(self):
        """Получение названия списка воспроизведения"""
    ...
    def get_video_stats(self):
        """Получение статистики по видео из списка воспроизведения"""
    ...
    def total_duration(self):
        """Подсчитывается общая продолжительность видео в списке воспроизведения"""
        total_time = []
    ...
    def show_best_video(self):
        """Получение URL-адреса наиболее понравившегося видео из списка воспроизведения"""
        video_likes = []
